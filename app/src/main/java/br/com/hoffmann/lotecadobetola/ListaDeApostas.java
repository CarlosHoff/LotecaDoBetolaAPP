...
import br.com.hoffmann.lotecadobetola.response.Usuario;
import br.com.hoffmann.lotecadobetola.utilitario.ApostaAdapter;

public class ListaDeApostas extends AppCompatActivity {

    private Button botaoIrPagamento, botaoInfo;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        botaoInfo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                new AlertDialog.Builder(ListaDeApostas.this).setTitle("Informcaoes").show();
            }
        });
        ...
        botaoIrPagamento.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(ListaDeApostas.this, PagamentoActivity.class);
    ...
    private void inciaComponente() {
        ...
        botaoInfo = findViewById(R.id.botao_info);
